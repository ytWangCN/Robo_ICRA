...
void protobuf_AssignDesc_static_5flayer_5fsetting_2eproto() {
  ...
  static const int ParaStaticLayer_offsets_[11] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ParaStaticLayer, blue_),
  };
...
const int ParaStaticLayer::kBlueFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 10: {
        ...
        if (input->ExpectTag(88)) goto parse_blue;
        break;
      }

      // required bool blue = 11;
      case 11: {
        if (tag == 88) {
         parse_blue:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
...
void ParaStaticLayer::SerializeWithCachedSizes(
  ...
  // required bool blue = 11;
  if (has_blue()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(11, this->blue(), output);
  }
...
::google::protobuf::uint8* ParaStaticLayer::InternalSerializeWithCachedSizesToArray(
  ...
  // required bool blue = 11;
  if (has_blue()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(11, this->blue(), target);
  }
...
// required bool blue = 11;
bool ParaStaticLayer::has_blue() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
void ParaStaticLayer::set_has_blue() {
  _has_bits_[0] |= 0x00000400u;
}
void ParaStaticLayer::clear_has_blue() {
  _has_bits_[0] &= ~0x00000400u;
}
void ParaStaticLayer::clear_blue() {
  blue_ = false;
  clear_has_blue();
}
 bool ParaStaticLayer::blue() const {
  // @@protoc_insertion_point(field_get:roborts_costmap.ParaStaticLayer.blue)
  return blue_;
}
 void ParaStaticLayer::set_blue(bool value) {
  set_has_blue();
  blue_ = value;
  // @@protoc_insertion_point(field_set:roborts_costmap.ParaStaticLayer.blue)
}

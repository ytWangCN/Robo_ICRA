...
class ParaStaticLayer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_costmap.ParaStaticLayer) */ {
 public:
  ...
  bool has_blue() const;
  void clear_blue();
  static const int kBlueFieldNumber = 11;
  bool blue() const;
...
// required bool blue = 11;
inline bool ParaStaticLayer::has_blue() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void ParaStaticLayer::set_has_blue() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ParaStaticLayer::clear_has_blue() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void ParaStaticLayer::clear_blue() {
  blue_ = false;
  clear_has_blue();
}
inline bool ParaStaticLayer::blue() const {
  // @@protoc_insertion_point(field_get:roborts_costmap.ParaStaticLayer.blue)
  return blue_;
}
inline void ParaStaticLayer::set_blue(bool value) {
  set_has_blue();
  blue_ = value;

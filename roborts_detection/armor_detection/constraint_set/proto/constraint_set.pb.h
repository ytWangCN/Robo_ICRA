...
class Threshold : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_detection.Threshold) */ {
 public:
  ...
  static const int kLightMinAspectRatioFieldNumber = 14;
  float light_min_aspect_ratio() const;
  void set_light_min_aspect_ratio(float value);

  // required float armor_min_aspect_ratio = 15;
  bool has_armor_min_aspect_ratio() const;
  void clear_armor_min_aspect_ratio();
  static const int kArmorMinAspectRatioFieldNumber = 15;
  float armor_min_aspect_ratio() const;
  void set_armor_min_aspect_ratio(float value);

  // required float radio = 16;
  bool has_radio() const;
  void clear_radio();
  static const int kRadioFieldNumber = 16;
  float radio() const;
  void set_radio(float value);
...
// required float radio = 16;
inline bool Threshold::has_radio() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void Threshold::set_has_radio() {
  _has_bits_[0] |= 0x00008000u;
}
inline void Threshold::clear_has_radio() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void Threshold::clear_radio() {
  radio_ = 0;
  clear_has_radio();
}
inline float Threshold::radio() const {
  // @@protoc_insertion_point(field_get:roborts_detection.Threshold.radio)
  return radio_;
}
inline void Threshold::set_radio(float value) {
  set_has_radio();
  radio_ = value;
